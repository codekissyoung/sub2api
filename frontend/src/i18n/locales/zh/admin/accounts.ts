export default {
    accounts: {
      ...
      poolEstimate: '号池估值 ≈ {usd} · {count} 号',
      poolEstimateHint: '按周限剩余 1% ≈ $20 估算（经验值），仅供参考',
      poolEstimateNewest: '最新数据：{time}',
      poolEstimateOldest: '最旧数据：{time}',
      poolEstimateMissing: '{count} 个号缺少用量数据，未计入估值',
      ...
      reAuthorize: '重新授权',
      refreshToken: '刷新令牌',
      refreshTokenConfirm: "确定刷新账号 '{name}' 的凭据吗？OpenAI 每次刷新都会消耗当前 RT 并签发新 RT，旧 RT 将立即失效，此操作无法撤销。",
      rotateRefreshToken: '轮换RT',
      rotateRefreshTokenConfirm: "确定轮换账号 '{name}' 的 RT 吗？成功后当前旧 RT 将立即失效，且无法撤销。",
      rotateRefreshTokenSuccess: 'RT 轮换成功，旧 RT 已失效',
      rotateRefreshTokenFailed: 'RT 轮换失败；若上游已消费旧 RT 但保存失败，请立即重新授权',
      noAccountsYet: '暂无账号',
      ...
      openai: {
        ...
        codexTurnTicketPaused: '未捕获到门票，该模型已暂停',
      ...
      tickets: {
        ...
        shapeDegraded: '降级票',
        shapeUnknown: '未知形状',
        degradedHint: '上游正在给该账号下发降级态（312）',
        length: '长度',
        remaining: '剩余',
        capturedAt: '捕获时间',
        expiresAt: '过期时间',
