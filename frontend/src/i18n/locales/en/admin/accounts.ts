export default {
    accounts: {
      ...
      poolEstimate: 'Pool value ≈ {usd} · {count} accts',
      poolEstimateHint: 'Estimated at $20 per 1% of weekly quota remaining (rule of thumb), for reference only',
      poolEstimateNewest: 'Newest data: {time}',
      poolEstimateOldest: 'Oldest data: {time}',
      poolEstimateMissing: '{count} account(s) missing usage data, excluded from the estimate',
      ...
      refreshTokenConfirm: "Refresh credentials for account '{name}'? OpenAI consumes the current RT on every refresh and issues a new one — the old RT becomes invalid immediately and this cannot be undone.",
      rotateRefreshToken: 'Rotate RT',
      rotateRefreshTokenConfirm: "Rotate the RT for account '{name}'? On success, the current RT becomes invalid immediately and this cannot be undone.",
      rotateRefreshTokenSuccess: 'RT rotated successfully; the previous RT is now invalid',
      rotateRefreshTokenFailed: 'RT rotation failed; re-authorize immediately if the provider consumed the old RT before persistence failed',
      ...
      openai: {
        ...
        codexTurnTicketPaused: 'No ticket captured; this model is paused',
      ...
      tickets: {
        ...
        shapeNormal: 'Normal',
        shapeDegraded: 'Degraded',
        shapeUnknown: 'Unknown shape',
        degradedHint: 'Upstream is issuing degraded (312) states to this account',
        length: 'Length',
        remaining: 'Remaining',
        capturedAt: 'Captured',
        expiresAt: 'Expires',
