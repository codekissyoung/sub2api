export default {
    settings: {
      ...
      rateLimit429Cooldown: {
        ...
        adaptiveEnabled: 'Enable Adaptive Cooldown',
        adaptiveEnabledHint: 'Use shared Redis to escalate generic OpenAI 429 cooldowns by consecutive strikes; one success resets the ladder',
        cooldownSeconds: 'Cooldown Duration (seconds)',
        fallbackCooldownSeconds: 'Fixed Fallback if Redis Fails (seconds)',
        cooldownSecondsHint: 'Default cooldown duration (1-7200 seconds); explicit upstream reset times still take precedence',
        firstCooldownSeconds: 'First Strike (seconds)',
        secondCooldownSeconds: 'Second Strike (seconds)',
        thirdCooldownSeconds: 'Third+ Strike (seconds)',
        strikeWindowSeconds: 'Strike Window (seconds)',
        adaptiveHint: 'Concurrent 429s inside one active cooldown are coalesced and do not instantly escalate the ladder. Explicit upstream reset times always win.',
