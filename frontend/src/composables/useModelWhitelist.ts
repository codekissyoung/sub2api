...
// OpenAI（与后端 openai.DefaultModels 保持一致）
const openaiModels = [
  // GPT-5.6 系列
...
const openaiPresetMappings = [
  ...
  { label: 'Opus→5.6 Sol', from: 'claude-opus-4-6', to: 'gpt-5.6-sol', color: 'bg-purple-100 text-purple-700 hover:bg-purple-200 dark:bg-purple-900/30 dark:text-purple-400' },
