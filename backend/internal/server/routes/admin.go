...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/openai-pool-estimate", h.Admin.Account.GetOpenAIPoolEstimate)
		...
		accounts.GET("/:id/codex-tickets", h.Admin.Account.CodexTickets)
		accounts.POST("/:id/recover-state", h.Admin.Account.RecoverState)
		accounts.POST("/:id/refresh", h.Admin.Account.Refresh)
		accounts.POST("/:id/rotate-refresh-token", h.Admin.Account.RotateOpenAIRefreshToken)
